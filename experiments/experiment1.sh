...
case "$experiment" in 
    ...
    # Experiment 1: Compare Normal and Super, Seq 06
        ...
        python $programfile/parameter_tuning.py -e display -n 6 -m compare -f inputs/comparison_params.txt -s results/comparisons/seq06 >> $logfile
    ...
    # Experiment 2: Compare Normal and Super, Seq 05
        ...
        python $programfile/parameter_tuning.py -e display -n 5 -m compare -f inputs/comparison_params.txt -s results/comparisons/seq05 >> $logfile 
    ...
    # Experiment 3: Compare Normal and Super, Seq 00
        ...
        python $programfile/parameter_tuning.py -e display -n 0 -m compare -f inputs/comparison_params.txt -s results/comparisons/seq00 >> $logfile 
    ...
    # Experiment 4: Compare Normal and Super, Seq 07
        ...
        python $programfile/parameter_tuning.py -e display -n 7 -m compare -f inputs/comparison_params.txt -s results/comparisons/seq07 >> $logfile 
